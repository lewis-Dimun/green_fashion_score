...
// Validate ../../src/app/api/fashion-scores/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/fashion-scores">> = Specific
  const handler = {} as typeof import("../../src/app/api/fashion-scores/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
